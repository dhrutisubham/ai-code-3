...
const HomeFeedPost = (post) => {
  return (
    <article className='bg-white1 rounded-lg drop-shadow p-4 px-6 flex flex-col gap-2'>
        {/* User Details  */}
    ...
    {/* Post Details  */}
    <section className='flex gap-2 text-black2  text-xs font-medium items-center w-full h-max-10 mt-2 min-h-max'>
